...
def test_valid_letter_of_credit() -> None:
    """Test test valid letter of credit."""
    lc = _valid_lc()
...
def test_lc_number_cannot_contain_colon() -> None:
    """Test test lc number cannot contain colon."""
    with pytest.raises(ValueError):
